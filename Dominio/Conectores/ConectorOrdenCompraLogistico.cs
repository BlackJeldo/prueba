        ...
        public void conectorOrdenCompraLogistico(string json)
        {
            ...
            for (int i = 0; i< Json.values.Count; i++)
            {
             _d1.Rows.Add(
                ...
                Json.values[i].f310IdTipoDocto,
                Json.values[i].f310ConsecDocto,
                Json.values[i].f318RowId,
                Json.values[i].f318IdServicio,
                Json.values[i].f318IdMotivo,
                Json.values[i].f318IdCoMovto,
                Json.values[i].f318IdUnMovto,
                Json.values[i].f318IdCCostoMovto,
                Json.values[i].f318IdTerceroMovto,
                Json.values[i].f318IdSucursalCliente,
                Json.values[i].f318IdSucursalProveedor,
                Json.values[i].f318Cantidad,
                Json.values[i].f318VlrBruto,
                Json.values[i].f318VlrDscto1,
                Json.values[i].f318VlrDscto2,
                Json.values[i].f318Notas,
                Json.values[i].f318Detalle,
